...
curl -L "alias.ra101.dev" > ~/.alias.sh

# Fetch aliases based on query param.
curl -L "alias-alchemy.ra101.dev?q=py,dj,docker" > ~/.alias.sh

# /help endpoint to get usage.
curl -L "alias.ra101.dev/help"

# /version endpoint to get version.
curl -L "alias.ra101.dev/version"</code></pre>
...
<tr><td> Any Tool </td> <td> <code> [tool] [header: {'User-Agent': 'alias'}] [url] > [filepath] </code> </td></tr>
</tbody></table>
...
<li> <a href="https://alias.ra101.dev?q="> alias.ra101.dev </a> </li>
<li> <a href="https://alias.ra101.deno.net?q="> alias.ra101.deno.net </a> </li> </ul>
...
<details>
	<summary> <h4 style="display:inline-block;">〉<a href="https://python.org/"> Python </a> (py) Aliases </h4> </summary>
...
<details>
	<summary> <h4 style="display:inline-block;">〉<a href="https://docker.com/"> Docker </a> (dk) Aliases </h4> </summary>
...
<details>
	<summary> <h4 style="display:inline-block;">〉<a href="https://podman.io/"> Podman </a> (pd) Aliases </h4> </summary>
...
# Kubernetes Aliases (kubectl, kubevirt, kubecolor, kustomize)
