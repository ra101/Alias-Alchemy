...
<pre style="overflow: hidden"><code class="language-bash"># Shell Aliases (debian, git)
...
<pre style="overflow: hidden"><code class="language-bash"># Python Aliases (py, py(uv), alembic, django, celery)
...
<details>
	<summary> <h4 style="display:inline-block;">〉<a href="https://www.docker.com/"> Docker </a> (dk) Aliases </h4> </summary>

<pre style="overflow: hidden"><code class="language-bash"># Docker Aliases (docker, compose, swarm)
